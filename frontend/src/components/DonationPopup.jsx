    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                ...
                setUserId(data.user._id); // Store the logged-in user's ID
                setUser(data.user);
            } catch (error) {
        ...
        fetchRecipient();
    }, [element.recipient_id]); // Include recipient_id as a dependency

    // Check if the logged-in user is the recipient
    if (userId === recipient._id) {
        return null; // Don't render the Confirmation component if the user is the recipient
    }
            ...
            <div className="confirmation">
                ...
                <div className="proceed">
                    ...
                    <div className="button-container">
                        <button
                            className={`button-main ${showContactInfo ? "hidden" : ""}`}
                ...
                <div className={`contact-info ${showContactInfo ? "" : "hidden"}`}>
